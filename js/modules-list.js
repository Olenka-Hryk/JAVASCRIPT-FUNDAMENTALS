const MODULES = [
  ...
  },
  {
    id: "ajax",
    chapter: "13",
    name: "13. COMMUNICATION WITH SERVER. AJAX",
    numberOfTasks: "3",
    tasks: [
      {
        id: "1",
        nameTask: "Update button content: ",
        descriptionTask:
          "На основі <code>AJAX</code> технології напишіть клієнтську частину аплікації (HTML+JavaScript), в якій при натисненні на кнопку надсилається асинхронний <code>GET</code>-запит на сервер, сервер обробляє запит і надсилає його на HTML-сторінку оновлюючи вміст кнопки так як показано в прикладі.",
      },
      {
        id: "2",
        nameTask: "Display a list of book authors: ",
        descriptionTask:
          "На основі <code>AJAX</code> технології напишіть клієнтську частину аплікації (HTML+JavaScript), в якій при натисненні на кнопку надсилається асинхронний <code>GET</code>-запит на сервер, завантажується файл <code>books.json</code> і з нього виводяться всі назви авторів у вигляді списку на HTML-сторінку.",
      },
      {
        id: "3",
        nameTask: "Display information about the user: ",
        descriptionTask:
          "Використати сервіс: <var>https://randomuser.me/</var>.  Та при кожному завантаженні сторінки робити запит до <code>API</code> та рендерити базову інформацію про користувача (<var>аватар, ім`я, вік, стать, країна, логін, пароль, пошта </var>).",
      }
    ],
  }
];